...
function getLinesArray(nodesArray, lineType, direction) {
  ...
  nodesArray.forEach(function (node) {
    ...
    var checkPushToLineArray = function checkPushToLineArray(linePath) {
    ...
    if (!node.expanded && !node.isHidden()) {
      checkPushToLineArray(line.getExpand());
    }

    checkPushToLineArray(line.draw());
  });
  return linesArray;
}
...
//# sourceMappingURL=1.5d13d4b072291d97034e.hot-update.js.map